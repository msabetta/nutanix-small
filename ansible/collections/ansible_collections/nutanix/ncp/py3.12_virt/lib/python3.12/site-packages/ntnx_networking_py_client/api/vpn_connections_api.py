...
class VpnConnectionsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_vpn_connection_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_vpn_appliance_for_vpn_connection_by_id(self, vpnConnectionExtId, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections/{vpnConnectionExtId}/vpn-vendor-configs/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_vpn_connection_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_vpn_appliances_by_vpn_connection_id(self, vpnConnectionExtId, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections/{vpnConnectionExtId}/vpn-vendor-configs', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_vpn_connections(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_vpn_connection_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/vpn-connections/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
