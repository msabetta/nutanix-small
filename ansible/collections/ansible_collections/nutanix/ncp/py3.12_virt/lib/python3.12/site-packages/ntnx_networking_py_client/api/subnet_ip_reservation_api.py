...
class SubnetIPReservationApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/subnets/{subnetExtId}/reserved-ips', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def reserve_ips_by_subnet_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/subnets/{extId}/addresses/$actions/reserve', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def unreserve_ips_by_subnet_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/subnets/{extId}/addresses/$actions/unreserve', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
