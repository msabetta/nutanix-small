...
class MacAddressesApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/layer2-stretches/{layer2StretchExtId}/learned-mac-addresses/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_learned_mac_addresses_by_layer2_stretch_id(self, layer2StretchExtId, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.3/config/layer2-stretches/{layer2StretchExtId}/learned-mac-addresses', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
