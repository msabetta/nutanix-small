...
class RecoveryPointRestorationSpec(object):
    ...
    :param is_instant_restore: (:attr:`is_instant_restore`) Indicates whether this is an instant restore task.  (**Default** False)
    ...
    def __init__(self, cluster_ext_id=None, vm_recovery_point_restore_overrides=None, volume_group_recovery_point_restore_overrides=None, is_instant_restore=False, *args, **kwargs):  # noqa: E501
