...
class HighAvailabilityState(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - NORMAL: Layer2 Stretch connection is in a normal state.
        - FAILOVER_IN_PROGRESS: Layer2 Stretch connection is undergoing a failover to restore the datapath.
        - FAILOVER_FAILED: Layer2 Stretch connection was unable to restore the datapath after attempting a failover.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    NORMAL = "NORMAL"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.HighAvailabilityState'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HighAvailabilityState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HighAvailabilityState):
            return False
