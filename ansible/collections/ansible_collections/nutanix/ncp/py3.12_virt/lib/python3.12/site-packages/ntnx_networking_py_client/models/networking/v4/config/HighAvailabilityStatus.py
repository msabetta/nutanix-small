...
from ntnx_networking_py_client.models.networking.v4.config.HighAvailabilityState import HighAvailabilityState  # noqa: F401,E501
...
class HighAvailabilityStatus(object):
    ...
    :param error_details: (:attr:`error_details`) Detailed text describing the most recent configuration failure.
    :type error_details: 
    ...
    """  # noqa: E501
    swagger_types = {
        'state': 'networking.v4.config.HighAvailabilityState',
        'error_details': 'str',
    ...
    def __init__(self, state=None, error_details=None, *args, **kwargs):  # noqa: E501
        self.__state = None
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.HighAvailabilityStatus'
    ...
    def state(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.HighAvailabilityState`
        """  # noqa: E501
        return self.__state
