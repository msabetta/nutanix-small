...
class CategoriesApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/config/categories', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_category_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/config/categories/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_category_by_id(self, extId, _expand=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/config/categories/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_categories(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/config/categories', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_category_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/config/categories/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
