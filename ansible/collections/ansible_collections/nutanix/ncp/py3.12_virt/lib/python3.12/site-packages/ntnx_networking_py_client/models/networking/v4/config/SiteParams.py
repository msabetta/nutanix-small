...
class SiteParams(object):
    ...
    def __init__(self, pc_cluster_reference=None, stretch_subnet_reference=None, connection_reference=None, stretch_interface_ip_address=None, vpn_interface_ip_address=None, default_gateway_ip_address=None, high_availability_group=None, *args, **kwargs):  # noqa: E501
