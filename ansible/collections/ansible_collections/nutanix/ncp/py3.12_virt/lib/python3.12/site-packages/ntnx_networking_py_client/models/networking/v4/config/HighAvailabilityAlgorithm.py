...
class HighAvailabilityAlgorithm(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - ACTIVE_BACKUP: Active-backup high availability algorithm where one gateway is active and others are in standby mode.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.HighAvailabilityAlgorithm'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HighAvailabilityAlgorithm, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HighAvailabilityAlgorithm):
            return False
