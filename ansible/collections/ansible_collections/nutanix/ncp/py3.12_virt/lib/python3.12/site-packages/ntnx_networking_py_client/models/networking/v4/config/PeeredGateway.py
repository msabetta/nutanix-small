...
class PeeredGateway(object):

    """Information about a peered gateway in a high availability group.

    :param ext_id: (:attr:`ext_id`) External ID of the peered gateway.
    :type ext_id: 
    ...
    def __init__(self, ext_id=None, status=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__status = None
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.PeeredGateway'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PeeredGateway, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PeeredGateway):
            return False
