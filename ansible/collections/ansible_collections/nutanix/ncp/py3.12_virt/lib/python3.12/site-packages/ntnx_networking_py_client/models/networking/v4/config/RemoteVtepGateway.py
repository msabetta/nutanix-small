...
from ntnx_networking_py_client.models.networking.v4.config.HighAvailabilityGroup import HighAvailabilityGroup  # noqa: F401,E501
...
class RemoteVtepGateway(NetworkingBaseModel):
    ...
    :param is_active: (:attr:`is_active`) Indicates whether the gateway can be used to service a subnet extension's datapath.
    :type is_active: 
    
    
    :param high_availability_group: (:attr:`high_availability_group`) 
    :type high_availability_group: 
    ...
    swagger_types = {
        ...
        'vpc_name': 'str',
        'is_active': 'bool',
        'high_availability_group': 'networking.v4.config.HighAvailabilityGroup',
    ...
    attribute_map = {
        ...
        'vpc_name': 'vpcName',
        'is_active': 'isActive',
        'high_availability_group': 'highAvailabilityGroup',
        'metadata': 'metadata',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
    ...
    def __init__(self, name=None, is_local=None, vxlan_port=None, cluster_reference=None, cluster_name=None, vpc_reference=None, vpc_name=None, is_active=None, high_availability_group=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__high_availability_group = None
        ...
        if high_availability_group is not None:
            self.__high_availability_group = high_availability_group
    ...
    @property
    def high_availability_group(self):
        """
        

        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.HighAvailabilityGroup`
        """  # noqa: E501
        return self.__high_availability_group

    @high_availability_group.setter
    def high_availability_group(self, high_availability_group):
