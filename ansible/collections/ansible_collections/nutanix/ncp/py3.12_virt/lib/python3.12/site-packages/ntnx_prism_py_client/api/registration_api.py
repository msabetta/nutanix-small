...
class RegistrationApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/management/domain-managers/{domainManagerExtId}/registrations/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_registrations(self, domainManagerExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.3/management/domain-managers/{domainManagerExtId}/registrations', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
