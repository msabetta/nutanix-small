...
IGNORE:
    ...
    OpenAPI spec version: 4.1.2-beta-2
...
class User(ExternalizableAbstractModel):
    ...
    :param default_landing_page_path: (:attr:`default_landing_page_path`) Default Landing Page for User
    :type default_landing_page_path: 
    ...
    attribute_map = {
        ...
        'default_landing_page_path': 'defaultLandingPagePath',
        'ext_id': 'extId',
        'links': 'links',
        'tenant_id': 'tenantId',
        '_reserved': '$reserved',
    ...
    def __init__(self, username=None, user_type=None, idp_id=None, display_name=None, first_name=None, middle_initial=None, last_name=None, email_id=None, locale=None, region=None, password=None, is_force_reset_password_enabled=None, additional_attributes=None, status=None, buckets_access_keys=None, last_login_time=None, created_time=None, last_updated_time=None, created_by=None, last_updated_by=None, description=None, creation_type=None, default_landing_page_path=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__default_landing_page_path = None
        ...
        if default_landing_page_path is not None:
            self.__default_landing_page_path = default_landing_page_path
    ...
    @property
    def default_landing_page_path(self):
        """
        ...
        :type:
                :class:`~str`
        """  # noqa: E501
        return self.__default_landing_page_path

    @default_landing_page_path.setter
    def default_landing_page_path(self, default_landing_page_path):
