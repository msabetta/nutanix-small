...
class UnconfiguredNodeListItem(object):
    ...
    :param is_cvm_exists: (:attr:`is_cvm_exists`) Indicates whether a CVM exists on the node.
    :type is_cvm_exists: 
    ...
    def __init__(self, foundation_version=None, rackable_unit_serial=None, node_uuid=None, rackable_unit_max_nodes=None, current_network_interface=None, node_position=None, cvm_ip=None, current_cvm_vlan_tag=None, is_secure_booted=None, is_cvm_exists=None, nos_version=None, cpu_type=None, hypervisor_type=None, hypervisor_version=None, interface_ipv6=None, cluster_id=None, attributes=None, rackable_unit_model=None, arch=None, hypervisor_ip=None, ipmi_ip=None, host_type=None, luks_status=None, *args, **kwargs):  # noqa: E501
        ...
        if is_cvm_exists is not None:
            self.__is_cvm_exists = is_cvm_exists
    ...
    def is_cvm_exists(self):
        ...
        :type:
                :class:`~bool`
        """  # noqa: E501
        return self.__is_cvm_exists

    @is_cvm_exists.setter
    def is_cvm_exists(self, is_cvm_exists):
